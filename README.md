...
English | [中文](README_zh.md) | [বাংলা](README_bn.md) | [Official Site](https://sheikhAI.com) | [Documentation](https://docs.sheikhAI.com)
...
Sheikh AI is a general-purpose AI Agent system that supports running various tools and operations in a sandbox environment.

Enjoy your own agent with Sheikh AI!

❤️ Like Sheikh AI? Give it a star 🌟 to support the development!

🚀 [Try a Demo](https://sheikhAI.com)
...
* `frontend`: Sheikh AI frontend
* `backend`: Sheikh AI backend
* `sandbox`: Sheikh AI sandbox
...
Based on the original [Sheikh AI](https://github.com/likhonsexikh/sheikh-ai) project.
